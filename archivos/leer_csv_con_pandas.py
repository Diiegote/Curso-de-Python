...
df_2 = pd.read_csv('archivos\\archivo_csv.csv')
...
#accediendo a la cantidad de filas y columnas con shape (es una propiedad)
filas_totales,columnas_totales = df.shape  #estamos desempaquetando
